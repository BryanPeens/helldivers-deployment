...
--     -- example structure
--     INSERT INTO stratagems (name, type, description, filename) VALUES
--     ('anti-personnel-minefield', 'Engineering Bay', 'Description of Stratagem 1', 'stratagem1.jpg'),
--     ('Stratagem 2', 'Type B', 'Description of Stratagem 2', 'stratagem2.jpg'),
--     ('Stratagem 3', 'Type C', 'Description of Stratagem 3', 'stratagem3.jpg');

--     {
--         "name": "anti-personnel-minefield",
--         "type": "Engineering Bay",
--         "description": "The EAT-17 Expandable Anti-Tank is a single-use weapon specially designed to wreak havoc on vehicle armor targets. When facing formidable armored foes, the EAT-17 Expandable Anti-Tank becomes your ultimate ally. The Stratagem delivers two rocket launchers, each capable of delivering a devastating blow, this weapon is designed to tear through the toughest of armor with ease. But here's the catch - the EAT-17 is a one-shot wonder. Once you've unleashed its payload, the launcher is discarded, so make every shot count. Whether you're facing off against hulking Terminids or menacing Automatons, the EAT-17 is your ticket to leveling the playing field and coming out on top.",
--         "filename": "anti-personnel-minefield.svg"
--     },